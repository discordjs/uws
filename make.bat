...
curl https://nodejs.org/dist/v8.11.4/node-v8.11.4-headers.tar.gz | tar xz -C targets
curl https://nodejs.org/dist/v8.11.4/win-x64/node.lib > targets/node-v8.11.4/node.lib
...
curl https://nodejs.org/dist/v10.9.0/node-v10.9.0-headers.tar.gz | tar xz -C targets
curl https://nodejs.org/dist/v10.9.0/win-x64/node.lib > targets/node-v10.9.0/node.lib
)
...
cl /I targets/node-v8.11.4/include/node /EHsc /Ox /LD /Fedist/uws_win32_57.node dist/src/*.cpp targets/node-v8.11.4/node.lib
cl /I targets/node-v9.11.2/include/node /EHsc /Ox /LD /Fedist/uws_win32_59.node dist/src/*.cpp targets/node-v9.11.2/node.lib
cl /I targets/node-v10.9.0/include/node /EHsc /Ox /LD /Fedist/uws_win32_64.node dist/src/*.cpp targets/node-v10.9.0/node.lib
